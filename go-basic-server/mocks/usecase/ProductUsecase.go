...
func (_m *ProductUsecase) CreateProduct(p *entity.Product) error {
	ret := _m.Called(p)
...
func (_m *ProductUsecase) DeleteProduct(id int) error {
	ret := _m.Called(id)
...
func (_m *ProductUsecase) GetAllProduct() []*entity.Product {
	ret := _m.Called()
...
func (_m *ProductUsecase) GetOneProductById(id int) (*entity.Product, error) {
	ret := _m.Called(id)
...
func (_m *ProductUsecase) UpdateProduct(id int, p *entity.Product) error {
	ret := _m.Called(id, p)
